            ...
            <div class="col-md-12">
              <div class="card">
                    ...
                    <ul class="navbar-nav pull-left">
                        <li class="nav-item dropdown">
                            <a class="nav-link" id="navbarDropdownProfile" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <h4 class="card-title"><i class="material-icons">label_important</i> &nbsp Tanggal Pengajuan : <?php echo date('d F Y', strtotime($id_sp['date_submission']))?></h4>
                ...
                <div class="card-body">
                  ...
                  echo form_open_multipart('needs/update_sp', $attributes);
                  ?>
                  <br>
                  <div class="row">
                      <div class="col-md-12">
                        <div class="form-group">
                          ...
                          <input class="form-control" type="date" name="date_sub" value="<?php echo $id_sp['date_submission']?>">
                    ...
                    <div class="row">
                      <div class="col-md-12">
                        <div class="form-group">
                          ...
                          <textarea name="description" rows="5" class="form-control" data-style="btn btn-link" id="exampleFormControlSelect1">
                          <?php echo $id_sp['description']?>
                          </textarea>
                    ...
                    <table class="table">
                      ...
                      foreach ($items as $key => $item):?>
                        <tr>
                          <td class="text-center">  
                            <div class="checkbox_item">
                              <label>
                                <input  type="checkbox" name="check_item[<?php echo $key; ?>]" value="<?php echo $key; ?>"  <?php if ($item['sp_id'] !== NULL) {
                                  echo 'checked';}?>>
                              </label>
                                <input type="hidden" name="unchecked[<?php echo $key; ?>]" value="<?php echo $key; ?>">
                                <input type="hidden" name="item[<?php echo $key; ?>]" value="<?php echo $item['item_id']; ?>">
                                <input type="hidden" name="isp_id[<?php echo $key; ?>]" value="<?php echo $item['isp_id']; ?>">
                                <input type="hidden" name="po_id" value="<?php echo $item['po_id']; ?>">
                                <input type="hidden" name="sp_id[<?php echo $key; ?>]" value="<?php echo $item['sp_id']; ?>">
                                <input type="hidden" name="id_sp" value="<?php echo $id_sp['sp_id']; ?>">
                            </div>
                          </td>
                          <td class="">
                            <?php 
                          ...
                          <td class="form-group text-center">
                            ...
                            <input type="hidden" name="qty_po[<?php echo $key; ?>]" value="<?php echo $item['qty_po'];?>">
                            <input class="<?php echo 'qty'.$key; ?>" type="hidden" style="text-align:center;width: 100px;" name="qty[<?php echo $key; ?>]" value="<?php if ($item['sp_id'] !== NULL) {
                                  if ($item['man_qty']) {
                                    echo $item['man_qty'];
                                  }else {
                                    echo $item['qty'];
                            ...
                            <output style="padding-left:20px" id="<?php echo 'nominal'.$key; ?>">
                              <?php
                                if ($item['sp_id'] !== NULL) {
                                  ...
                                  $nominal = $qty*$item['custom_price'];
                                }else {
                                  $nominal = $item['qty_po']*$item['custom_price'];
                                }
                        ...
                        function clo_manual_qty<?php echo $key;?>(that) {
                          ...
                          var qty = <?php if ($item['sp_id'] !== NULL) {
                              if ($item['man_qty']) {
                                echo $item['man_qty'];
                              }else {
                                echo $item['qty'];
                  ...
                  <br><br>
                  <div align="center">
                  <a class="btn pull-center" href="<?php echo site_url('/needs/list_sp/'.$id_sp['po_id']);?>">
                  <i class="material-icons">cancel</i>&nbsp; Batal</a>
                  <a class="btn pull-center" href="<?php echo site_url('/needs/edit_po/'.$id_sp['dateneed_id'].'/'.$id_sp['po_id'].'/'.$id_sp['sp_id']);?>" style="color:white; background-color:#12B8CD;">
                  <i class="material-icons">edit</i>&nbsp; Edit PO</a>
                  <button type="submit" name="submit" onclick="" class="btn btn-primary pull-center" style="background-color:#9C27B0">

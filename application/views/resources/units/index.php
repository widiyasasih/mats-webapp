              ...
              <div class="card">
                <div class="card-header card-header-danger">
                    ...
                    <ul class="navbar-nav pull-left">
                        <li class="nav-item dropdown">
                            <a class="nav-link" id="navbarDropdownProfile" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <i class="material-icons">label_important</i> &nbsp Satuan Unit
                    ...
                    <ul class="navbar-nav pull-right nav nav-tabs">
                        <li class="nav-item">
                            <a class="nav-link active" href="<?php echo site_url('resources/units/add_unit');?>">
                        ...
                        <tr>
                          ...
                          <td>
                            <!-- <ul class="navbar-nav pull-right nav nav-tabs" data-tabs="tabs"> -->
                              <!-- <li class="nav-item"> -->
                                  <a href="<?php echo site_url('resources/units/edit/'.$unit['id']);?>" title="Edit">
                                      <i class="material-icons">edit</i>
                                      <div class="ripple-container"></div>
                                  </a> &nbsp &nbsp
                                  <a onclick="return confirm('Anda yakin akan menghapus unit <?php echo $unit['unit'];?> ?')" href="<?php echo site_url('resources/units/delete/'.$unit['id']);?>" title="Delete" style="color:#e8021d;">

        ...
        <div class="container-fluid">
          <div class="row">
            <div class="col-md-8">
              <div class="card-body">
                  <?php echo form_open_multipart('resources/units/update');?>
                    <div class="row">
                    ...
                    <input type="hidden" name="id" value="<?php echo $unit['id'];?>">
                      <div class="col-md-12">
                        <div class="form-group">
                          ...
                          <input type="text" name="unit" class="form-control" value="<?php echo $unit['unit'];?>">
                        </div>
                      </div>
                    </div>
                    <br>
                    ...
                    <div align="right">
                    <a class="btn pull-center" href="<?php echo site_url('resources/units');?>" style="color:white;" id="tambahModel">

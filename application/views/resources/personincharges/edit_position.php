        ...
        <div class="container-fluid">
          <div class="row">
            <div class="col-md-8">
              <div class="card-body">
                  <?php echo form_open_multipart('resources/update_position');?>
                    <div class="row">
                    ...
                    <input type="hidden" name="id" value="<?php echo $position['id'];?>">
                      <div class="col-md-12">
                        <div class="form-group">
                          ...
                          <input type="text" name="position" class="form-control" value="<?php echo $position['position'];?>">
                        </div>
                      </div>
                    </div>
                    <br>
                    ...
                    <div align="right">
                    <a class="btn pull-center" href="<?php echo site_url('resources/view_position');?>" style="color:white;" id="tambahModel">
